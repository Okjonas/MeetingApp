...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FoldingCell",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@property (nonatomic, strong) IBOutlet NSLayoutConstraint * _Null_unspecified containerViewTop;
/// UIView whitch display when cell close
@property (nonatomic, strong) IBOutlet RotatedView * _Null_unspecified foregroundView;
@property (nonatomic, strong) IBOutlet NSLayoutConstraint * _Null_unspecified foregroundViewTop;
...
- (NSTimeInterval)animationDuration:(NSInteger)itemIndex type:(enum AnimationType)type SWIFT_WARN_UNUSED_RESULT;
...
- (void)animationDidStart:(CAAnimation * _Nonnull)_;
