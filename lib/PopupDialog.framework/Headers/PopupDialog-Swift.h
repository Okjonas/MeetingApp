...
@property (nonatomic) BOOL liveBlur SWIFT_DEPRECATED_MSG("liveBlur has been deprecated and will be removed with future versions of PopupDialog. Please use isLiveBlurEnabled instead.");
@end

typedef SWIFT_ENUM(NSInteger, PopupDialogTransitionStyle, closed) {
