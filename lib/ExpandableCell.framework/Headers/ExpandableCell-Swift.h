...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ExpandableCell",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class NSCoder;

SWIFT_CLASS("_TtC14ExpandableCell14ExpandableCell")
...
SWIFT_CLASS("_TtC14ExpandableCell19ExpandableTableView")
...
@interface ExpandableTableView (SWIFT_EXTENSION(ExpandableCell)) <UITableViewDataSource, UITableViewDelegate>
...
@interface ExpandableTableView (SWIFT_EXTENSION(ExpandableCell))
- (void)reloadData;
